...
TRANSLATIONS = {
    "EN": {
        ...
        <style>
            ...
            h1 { color: #ffffff; border-bottom: 2px solid #ffffff; padding-bottom: 5px; margin-top: 30px; font-size: 24px; }
            h2 { color: #ffffff; margin-top: 25px; border-left: 4px solid #ffffff; padding-left: 10px; font-size: 20px; }
            h3 { color: #ffffff; margin-top: 20px; font-size: 16px; font-weight: bold; }
            .highlight { color: #ffffff; font-weight: bold; border-bottom: 1px dotted #ffffff; }
            .code { background-color: #111; padding: 3px 6px; border-radius: 4px; font-family: monospace; color: #fff; border: 1px solid #333; }
            .box { border: 1px solid #333; padding: 20px; border-radius: 8px; margin-bottom: 20px; }
        ...
        <div style="text-align: center; margin-bottom: 40px;">
            ...
            <p style="color: #888; font-weight: bold; letter-spacing: 2px;">POTENT . PURE . PERMANENT</p>
        </div>
        <div class="box">
        ...
        <p style="text-align: right; color: #444; margin-top: 50px; font-size: 11px;">
    ...
    "KO": {
        ...
        "guide_html": """
        <style>
            body { color: #ffffff; background-color: #000000; font-family: 'Malgun Gothic', sans-serif; line-height: 1.6; padding: 20px; }
            h1 { color: #ffffff; border-bottom: 2px solid #ffffff; padding-bottom: 5px; margin-top: 30px; font-size: 24px; }
            h2 { color: #ffffff; margin-top: 25px; border-left: 4px solid #ffffff; padding-left: 10px; font-size: 20px; }
            h3 { color: #ffffff; margin-top: 20px; font-size: 16px; font-weight: bold; }
            .highlight { color: #ffffff; font-weight: bold; border-bottom: 1px dotted #ffffff; }
